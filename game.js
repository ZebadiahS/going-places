  ...
  class Player {
    ...
    update(input, platforms, background) {
      ...
      if (
        ...
        window.tmState.className === "forward"
      ) {
        this.speed = 5;
        this.frameY = 1;
      } else if (
        input.keys.indexOf("ArrowLeft") > -1 ||
        window.tmState.className === "backward"
      ) {
      ...
      if (
        (input.keys.indexOf("ArrowUp") > -1 && this.grounded) ||
        (window.tmState.className === "jump" && this.grounded)
      ) {
      ...
      if (!this.grounded && window.tmState.className === "forward") {
        ...
        (!this.grounded && window.tmState.className === "backward") ||
        (input.keys.indexOf("ArrowLeft") > -1 && !this.grounded)
      ) {
        this.frameY = 6;
